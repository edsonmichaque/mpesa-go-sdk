...
func (c *Client) Receive(params map[string]string)  (*mpesa.Response, *mpesa.Error) {
	return c.service.HandleReceive(params)
}

func (c *Client) Send(params map[string]string) (*mpesa.Response, *mpesa.Error) {
	return c.service.HandleSend(params)
}

func (c *Client) Revert(params map[string]string) (*mpesa.Response, *mpesa.Error) {
	return c.service.HandleRevert(params)
}

func (c *Client) Query(params map[string]string) (*mpesa.Response, *mpesa.Error) {
